...
def process_song_data(spark, input_data, output_data):
    ...
    print("song_table==========parquet file created")
    ...
    print("artists_table==========parquet file created")
...
def process_log_data(spark, input_data, output_data):
    ...
    print("users_table==========parquet file created")
...
#-------------------------------------------
    ...
    print("time_table==========parquet file created")
    ...
    songplay = df_total["start_time", "userId", "level", "song_id", "artist_id", "sessionId", "location", "userAgent", "year", "month"]

    # write songplays table to parquet files partitioned by year and month
    songplay.write.partitionBy("year", "month").parquet(os.path.join(output_data,"song_plays.parquet"), "overwrite")
    print("songplay_table==========parquet file created")
